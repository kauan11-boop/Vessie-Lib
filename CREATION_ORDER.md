...
### Fase 9 — Preview de Arquivos (HTML/SVG/Markdown)
| # | Caminho | Descrição |
|---|---------|-----------|
| 32 | `js/preview.js` | Módulo `FilePreview`: botão "visualizar", modal sandbox, drag & drop |
| 33 | `css/preview.css` | Estilos do botão, modal de preview e dropzone |
| 34 | `index.html` | Inclui `css/preview.css` e `js/preview.js` |
| 35 | `js/app.js` | Ícone `eye`, `window.icon` exposto e chamada `FilePreview.enhance(pre)` |
| 36 | `PREVIEW_ORDER.md` | Documento de planejamento do preview |
